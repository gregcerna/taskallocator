"""autogenerated by genpy from taskallocator/Task.msg. Do not edit."""
import sys
...
class Task(genpy.Message):
  _md5sum = "23298917be122f4030b24018b6283f17"
  _type = "taskallocator/Task"
...
"""
  __slots__ = ['header','instructions']
  _slot_types = ['std_msgs/Header','taskallocator/Instruction[]']
